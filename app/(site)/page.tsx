    ...
    <div className="bg-transparent">
      <div className="mx-auto flex min-h-[calc(100vh-64px-72px)] w-full max-w-6xl items-center px-4 py-10 sm:px-6">
        ...
        <div className="grid w-full items-start gap-8 md:grid-cols-[360px_1fr]">
          {/* LEFT COLUMN (stack panels) */}
          <div className="flex flex-col gap-6">
            {/* LEFT: Profile + Education (UNCHANGED) */}
            ...
            {/* ✅ NEW: Separate Recent Activity box BELOW profile/education */}
            <section className="rounded-3xl border border-black bg-white/80 p-5 shadow-sm backdrop-blur-md">
              ...
              <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-relaxed text-black">
                <li>
                  <Link
                    href="https://egusphere.copernicus.org/preprints/2025/egusphere-2025-4492/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="underline decoration-black/40 underline-offset-2 transition hover:decoration-black"
                  >
                    Co-author: dust &amp; ice nuclei paper
                  </Link>
                </li>

                <li>
                  <Link
                    href="https://water.utah.gov/snowscape/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="underline decoration-black/40 underline-offset-2 transition hover:decoration-black"
                  >
                ...
                <li>Defended MS thesis in Atmospheric Sciences</li>
                ...
                <li>
                  <Link
                    ...
                    className="underline decoration-black/40 underline-offset-2 transition hover:decoration-black"
                  >
                    On-site support: mountain instrument sites (S2noClime)
                  </Link>
                </li>
              </ul>
            </section>
          ...
          <section className="flex h-full flex-col rounded-3xl border border-black bg-white/80 p-6 shadow-sm backdrop-blur-md sm:p-7">
            ...
            <p className="mt-3 text-base leading-relaxed text-black">
              I recently completed my MS thesis in Atmospheric Sciences focused on air quality
              research. While my thesis centered on atmospheric chemistry and climate modeling, I
              naturally became heavily involved in field campaign work that required engineering
              skillsets, which I had already developed through my education, industry experience, and
              personal projects. This work included instrument installation, data collection and
              management, and the design and construction of a remote, mobile mountain laboratory.
            </p>

            <p className="mt-3 text-base leading-relaxed text-black">
              I am currently seeking an engineering role where I can contribute as a practical,
              detail-oriented engineer. While air quality challenges strongly motivate me, I am
              excited to work on a broad range of real-world engineering problems.
            </p>

            <p className="mt-3 text-base leading-relaxed text-black">
              I have designed this website to share some of my professional experience, a little bit
              about my personal interests, and a sample of my project portfolio. Thanks for checking
              it out!
            </p>
