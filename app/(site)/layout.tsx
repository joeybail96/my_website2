...
function BottomSocialBar() {
  return (
    <footer className="sticky bottom-0 z-50 border-t border-zinc-200 bg-white/90 backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/80">
      <div className="mx-auto flex w-full max-w-7xl flex-col items-start justify-between gap-3 px-6 py-3 sm:flex-row sm:items-center">
        ...
        <div className="flex flex-wrap items-center gap-5">
          ...
          <a
            ...
            className="flex items-center gap-2 text-sm font-semibold text-zinc-900 transition hover:opacity-80 dark:text-zinc-100"
          >
            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="text-[#4285F4]">
          ...
          <a
            ...
            className="flex items-center gap-2 text-sm font-semibold text-zinc-900 transition hover:opacity-80 dark:text-zinc-100"
          >
            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" className="text-[#FF0084]">
      ...
      <header className="sticky top-0 z-50 bg-blue-200/90 text-zinc-900 shadow-sm backdrop-blur-md dark:bg-blue-900/60 dark:text-zinc-100">
        <nav className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4">
          <Link href="/" className="text-lg font-semibold tracking-tight hover:opacity-80">
            Joey Bail <span className="ml-1 text-xs font-normal text-zinc-600 dark:text-zinc-300">(homepage)</span>
          </Link>

          <div className="flex items-center gap-6">
            <Link href="/about" className="text-sm transition hover:text-blue-800 dark:hover:text-blue-300">About</Link>
            <Link href="/projects" className="text-sm transition hover:text-blue-800 dark:hover:text-blue-300">Projects</Link>
            <Link href="/contact" className="text-sm transition hover:text-blue-800 dark:hover:text-blue-300">Contact</Link>
          </div>
        </nav>
      </header>
